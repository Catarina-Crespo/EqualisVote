...
function findWasmBinary() {
  if (Module['locateFile']) {
    return locateFile('shuffle_user.wasm');
  }
  // Use bundler-friendly `new URL(..., import.meta.url)` pattern; works in browsers too.
  return new URL('shuffle_user.wasm', import.meta.url).href;
}
...
var ASM_CONSTS = {
  21160: () => { return Module.getRandomValue(); },  
...
var _shuffle_user = Module['_shuffle_user'] = createExportWrapper('shuffle_user', 3);
